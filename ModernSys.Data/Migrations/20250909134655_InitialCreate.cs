    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Departments",
                columns: new[] { "DepartmentId", "DepartmentDesc", "DepartmentName" },
                values: new object[] { 1, "Handles system administration and configuration.", "Administration" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Can manage users", "ManageUsers" },
                    { 2, "Can manage inventory", "ManageInventory" },
                    { 3, "Can view reports", "ViewReports" },
                    { 4, "Can manage departments", "ManageDepartments" }
                });
